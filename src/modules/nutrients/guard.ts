import type { Fertilizer, FertilizerRow, FertilizerWateringSchemaRow, WateringSchemaRow } from './types'
...
export function isFertilizerRow(value: any): value is FertilizerRow {
  return typeof value === 'object'
    && hasNumKey(value, 'id')
    && hasStrKey(value, 'name')
    && hasOptionalStrKey(value, 'manufacturer')
